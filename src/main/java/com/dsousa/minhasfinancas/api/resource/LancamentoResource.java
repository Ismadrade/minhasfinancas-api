...
public class LancamentoResource {
	...
	*/
	...
	public ResponseEntity buscar(
			...
			@RequestParam("usuario") Long idUsuario //é obrigatorio
	...
	public ResponseEntity atualizar( @PathVariable("id") Long id, @RequestBody LancamentoDTO dto) {
		...
		return service.obterPorId(id).map( entity -> { //entity recebe o lançamento encontrado no banco de dados
			
			try {
				Lancamento lancamento = converter(dto); //criado objeto lancamento recebendoa  conversao do dto
